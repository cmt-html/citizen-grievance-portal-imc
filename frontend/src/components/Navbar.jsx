            ...
            <div className="container">
                <div className="brand-row flex items-center justify-between py-2 md:py-0">
                    <div className="brand-left">
                        <Link href="/">
                            <img src="/images/imc-indore-logo.svg" alt="IMC Indore Logo" className="brand-logo max-w-[220px] md:max-w-[284px] h-auto drop-shadow-sm transition-transform hover:scale-[1.02]" />
                        </Link>
                    </div>
